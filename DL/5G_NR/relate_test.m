...
for i = 1:length(N_ID_2_list)
    ...
    xlabel('Delay');
    ylabel('Magnitude');
    title(sprintf('Auto-correlation of N_ID_2=%d', N_ID_2));
    grid on;
    ...
    for j = i+1:length(N_ID_2_list)
        ...
        xlabel('Delay');
        ylabel('Magnitude');
        title(sprintf('Cross-correlation between N_ID_2=%d and N_ID_2=%d', N_ID_2, N_ID_2_other));
        grid on;
        ...
        xlabel('Delay');
        ylabel('Magnitude');
        title(sprintf('Cross-correlation between N_ID_2=%d and N_ID_2=%d', N_ID_2_other, N_ID_2));
        grid on;
    end
end
